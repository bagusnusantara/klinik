...
<div class="form-group row">
    <label for="users_id" class="col-md-4 col-form-label text-md-right">{{ __('ID Pasien') }}</label>
    <div class="col-md-6">
        <input id="users_id" type="text" class="form-control" value="{{ $list_pasien->id }}" name="users_id" readonly="readonly">
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    <label for="trans_keluhan_id" class="col-md-4 col-form-label text-md-right">{{ __('ID Keluhan') }}</label>
    <div class="col-md-6">
        <input id="trans_keluhan_id" type="text" class="form-control" value="{{ $list_pasien->id_keluhan }}" name="trans_keluhan_id" readonly="readonly">
    </div>
</div>
<div class="form-group row">
